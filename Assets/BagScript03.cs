...
public class BagScript03 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (numSands == 2)
        {
            GameObject.Find("WizardDialog").GetComponent<Animator>().SetBool("TwoSands", true);
        }
    ...
    public void addObject(GameObject item)
    {
        ...
        {
            GameObject.Find("WizardDialog").GetComponent<Animator>().SetBool("Sand2", true);
    ...
    void dropItem()
    {
        ...
        else if (iconLocator == 2 && sand_1.activeSelf == true)
        {
            ...
            GameObject.Find("WizardDialog").GetComponent<Animator>().SetBool("Sand2", false);
