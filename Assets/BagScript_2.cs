...
public class BagScript_2 : MonoBehaviour
{
	...
	void dropItem()
	{
		...
		if (iconLocator <= 1 && GameObject.Find("SceneGranite") == null && granite_1.activeSelf == true)
		{
			...
			objectList.SetValue(0, 0);
			if (eventManager.GetComponent<EventManager02>() != null)
			{
				eventManager.GetComponent<EventManager02>().takeFromBag(granite_1);
			}
			else
			{
				eventManager.GetComponent<EventManager02>().takeFromBag(granite_1);
		...
		else if (iconLocator == 2 && GameObject.Find("SceneGranite (1)") == null && granite_2.activeSelf == true)
		{
			...
			if (eventManager.GetComponent<EventManager02>() != null)
			{
				eventManager.GetComponent<EventManager02>().takeFromBag(granite_2);
			}
			else
			{
				eventManager.GetComponent<EventManager02>().takeFromBag(granite_2);
		...
		else if (iconLocator == 3 && sand_1.activeSelf == true)
		{
			...
			if (eventManager.GetComponent<EventManager02>() != null)
			{
				eventManager.GetComponent<EventManager02>().takeFromBag(sand_1);
			}
			else
			{
				eventManager.GetComponent<EventManager02>().takeFromBag(sand_1);
		...
		else if (iconLocator >= 4 && sand_2.activeSelf == true)
		{
			...
			if (eventManager.GetComponent<EventManager02>() != null)
			{
				eventManager.GetComponent<EventManager02>().takeFromBag(sand_2);
			}
			else
			{
				eventManager.GetComponent<EventManager02>().takeFromBag(sand_2);
